...
@.str2 = private unnamed_addr constant [34 x i8] c"sum == 210 * a + 12 * b + 111 * c\00", align 1
...
; <label>:112                                     ; preds = %108
  ...
  %135 = mul nsw i32 210, %134, !dbg !160
  %136 = load i32* %2, align 4, !dbg !160
  %137 = mul nsw i32 12, %136, !dbg !160
  %138 = add nsw i32 %135, %137, !dbg !160
  %139 = load i32* %3, align 4, !dbg !160
  %140 = mul nsw i32 111, %139, !dbg !160
  %141 = add nsw i32 %138, %140, !dbg !160
  %142 = icmp eq i32 %133, %141, !dbg !160
  br i1 %142, label %228, label %143, !dbg !160

; <label>:143                                     ; preds = %112
  call void @__assert_fail(i8* getelementptr inbounds ([34 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str1, i32 0, i32 0), i32 28, i8* getelementptr inbounds ([50 x i8]* @__PRETTY_FUNCTION__.print_all_combinations_and_sum, i32 
  unreachable, !dbg !160
